...
if __name__ == "__main__":
    ...
    parser.add_argument('n_colors', default=2 , nargs="?")
    parser.add_argument('superpixel_size', default=2, nargs="?")
    parser.add_argument('saturation', default=1.5 , nargs="?")
    parser.add_argument('contrast', default=1.7 , nargs="?")
